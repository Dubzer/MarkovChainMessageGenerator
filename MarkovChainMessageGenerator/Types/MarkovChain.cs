...
namespace Markov
{
    ...
    {
        public Dictionary<ChainState<T>, Dictionary<T, int>> items = new Dictionary<ChainState<T>, Dictionary<T, int>>();
        public int order;
        public Dictionary<ChainState<T>, int> terminals = new Dictionary<ChainState<T>, int>();
        ...
        {
            string sentence = string.Join(" ", Chain(random));
